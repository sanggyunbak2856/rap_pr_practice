...
annotate entity ZSK_C_PR_HDR_ADMIN
    with 
{
    @UI.facet: [{
      id: 'Header',
      ...
      label: 'Header Detail For Admin',
      position: 10
    }, {
      id: 'Item',
      purpose: #STANDARD,
      type: #LINEITEM_REFERENCE,
      label: 'Item Info For Admin ',
      position: 20,
      targetElement: '_Item'
    }]
    ...
    @UI: {
      lineItem:        [{ position: 20, label: '구매요청상태' },
                        { position: 20, label: '주문처리', dataAction: 'setProcessStatus', type: #FOR_ACTION },
                        { position: 20, label: '출고', dataAction: 'setShippingStatus', type: #FOR_ACTION }],
